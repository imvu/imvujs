...
module({
    ...
    FakeXMLHttpRequest.prototype.send = function (body) {
        FakeXMLHttpRequest.triggerExpectation(this, body);
    };
    ...
    FakeXMLHttpRequest.expect = function (method, url, responseCode, responseHeaders, responseBody, callback) {
    ...
    FakeXMLHttpRequest.allResolved = function () {
        return Object.keys(expectations).length === 0;
    };

    FakeXMLHttpRequest.triggerExpectation = function (xhr, body) {
    ...
    FakeXMLHttpRequest.resetExpectations = function () {
        expectations = {};
    };
